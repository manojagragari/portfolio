...
MEDIA_URL = '/media/'
# Use MEDIA_ROOT from env when provided (Render disk), otherwise fallback to local writable path.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'no-reply@portfolio.local')
